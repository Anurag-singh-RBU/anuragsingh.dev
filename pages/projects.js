          ...
          <ProjectCard
            ...
            links={[
              {icon: (
                ...
                ), type: "Source", href: "https://github.com/Anurag-singh-RBU/WEATHER-APP" }
            ]}
          />

          <ProjectCard
            title="TODO App"
            href="https://tickboard.vercel.app"
            description="This is a basic todo app created using next js and Typescript also used local storage for data storage and tailwind for sleek design."
            ...
            "Typescript",
            "Vercel"]}
            link="https://tickboard.vercel.app"
            image="/todo.jpg"
            links={[
              {icon: <Globe size={13}/>, type: "Website", href: "https://tickboard.vercel.app" },
              { icon: (
                <svg 
                  xmlns="http://www.w3.org/2000/svg" 
                  viewBox="0 0 438.549 438.549" 
                ...
                ), type: "Source", href: "https://github.com/Anurag-singh-RBU/todo-next-ts" }
            ]}
          />
        </div>
