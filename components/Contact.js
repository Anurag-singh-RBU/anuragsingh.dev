...
export default function Contact() {
  ...
  return (
    <div className="border border-blue-200 rounded p-6 my-4 w-full dark:border-gray-800 bg-blue-50 dark:bg-blue-opaque mt-20">
      ...
      <p className="my-1 text-gray-800 dark:text-blue-700 font-mono text-sm mb-3" style={{wordSpacing : "-3px"}}>
      ...
      <form className="relative my-4" onSubmit={subscribe}>
        <input
          ...
          autoComplete="email"
          required
          className="px-4 py-2 placeholder:text-sm mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full border-gray-300 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
        />
        <button
