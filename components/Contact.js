  ...
  return (
    <div className="border border-blue-200 rounded p-6 my-4 w-full dark:border-gray-800 bg-blue-50 dark:bg-blue-opaque mt-20">
      ...
      <form className="relative my-4" onSubmit={subscribe}>
        ...
        />
        <button
          className="flex items-center justify-center absolute right-1 top-1 px-4 font-bold font-mono h-8 bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded w-28"
          type="submit"
        >
