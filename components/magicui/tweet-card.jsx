        ...
        <a
          ...
          {/* {tweet.user.verified ||
            (tweet.user.is_blue_verified && (
              <Verified className="ml-1 inline text-blue-500" />
            ))} */}
        </a>
...
export const TweetBody = ({ tweet }) => (
  <div className="break-words leading-normal tracking-tighter text-justify font-bold">
    ...
    <div className="flex flex-col items-center justify-center gap-4 w-full">
      {tweet.video && (
        <video
          ...
          muted
          playsInline
          className="rounded-xl border shadow-sm w-full max-w-full">
...
export const MagicTweet = ({
  ...
  return (
    <div
      className={cn(
        "relative flex flex-col gap-2 overflow-hidden rounded-lg border p-4 backdrop-blur-md max-w-3xl mx-auto",
        className
      )}
      {...props}>
