...
<HighlightBox>
  <strong>Example:</strong> The following iterates over an array of numbers and returns a new
...
<HighlightBox>
  <strong>Example:</strong> The following iterates over an array of numbers and filters the array
...
<HighlightBox>
  <strong>Example:</strong> Sum all the numbers of the array numbers = [1, 2, 3] and return the result
</HighlightBox>
...
<HighlightBox>
  <strong>Example:</strong> Iterate over the numbers = [1, 2, 3, 4] array and check if it is even or odd.
</HighlightBox>
...
<HighlightBox>
  <strong>Example:</strong> Check the age of the person in the ages array. ages = [12, 32, 42, 22, 13], if the
...
<HighlightBox>
  <strong>Note:</strong> The interviewer might ask the difference between the three. Other
...
1. <HighlightBox>
     <strong>Default Binding</strong> - `this` points to global scope.
   </HighlightBox>
2. <HighlightBox>
     <strong>Implicitly</strong> - using dot notation
   </HighlightBox>
...
3. <HighlightBox>
     <strong>Explicitly</strong> - Force a function to use an object at their `this` place. Here,
